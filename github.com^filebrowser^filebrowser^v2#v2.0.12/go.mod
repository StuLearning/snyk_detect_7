module github.com/filebrowser/filebrowser/v2-v2.0.12

go 1.17

require github.com/filebrowser/filebrowser/v2 v2.0.12
...
require (
	...
	github.com/hacdias/fileutils v0.0.0-20181202104838-227b317161a1 // indirect
