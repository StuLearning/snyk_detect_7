module github.com/git-lfs/git-lfs-v2.5.2+incompatible

go 1.17

require github.com/git-lfs/git-lfs v2.5.2+incompatible
...
require (
	...
	github.com/git-lfs/wildmatch v1.0.4 // indirect
